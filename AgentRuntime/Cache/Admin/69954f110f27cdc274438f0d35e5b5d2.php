            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <h3 class="box-title"><a href="<?php echo U('Agent/listModules');?>"><button type="button" class="btn btn-block btn-primary">模块列表</button></a></h3>
                        <h3 class="box-title"><a href="<?php echo U('Agent/addmodule');?>"><button type="button" class="btn btn-block btn-default">添加模块</button></a></h3>
