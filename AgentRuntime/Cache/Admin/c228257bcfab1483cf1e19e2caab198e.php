            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href="<?php echo U('Agent/listAdmins');?>"><button type="button" class="btn btn-block btn-default">管理员列表</button></a></h3>
                        <h3 class="box-title"><a href="<?php echo U('Agent/listRoles');?>"><button type="button" class="btn btn-block btn-primary">角色列表</button></a></h3>
                        ...
                        <h3 class="box-title"><a href="<?php echo U('Agent/addRole');?>"><button type="button" class="btn btn-block btn-default">添加角色</button></a></h3>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <td>
                      ...
                      <a href="<?php echo U('Agent/editRole',array('roleid'=>$vo['role_id'],'gd'=>$groupId,'md'=>$menuId));?>">编辑</a>
                        <a href="javascript:if(confirm('确实要删除吗?'))location='<?php echo U('Agent/deleteRole',array('roleid'=>$vo['role_id'],'gd'=>$groupId,'md'=>$menuId));?>'">删除</a>
                       <a href="<?php echo U('Agent/listResources',array('roleid'=>$vo['role_id'],'gd'=>$groupId,'md'=>$menuId));?>">资源</a>
                 </td>
