            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href="<?php echo U('Agent/listAdmins');?>"><button type="button" class="btn btn-block btn-primary">管理员列表</button></a></h3>
                        <h3 class="box-title"><a href="<?php echo U('Agent/listRoles');?>"><button type="button" class="btn btn-block btn-default">角色列表</button></a></h3>
                        <h3 class="box-title"><a href="<?php echo U('Agent/listModules');?>"><button type="button" class="btn btn-block btn-default">模块列表</button></a></h3>
                        <h3 class="box-title"><a href="<?php echo U('Agent/addAdmin');?>"><button type="button" class="btn btn-block btn-default">添加管理员</button></a></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($listadmins)): $i = 0; $__LIST__ = $listadmins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tnd">
                             ...
                             <td>
                                 <a href="<?php echo U('Agent/editAdmin',array('adminid'=>$vo['admin_id'],'gd'=>$groupId,'md'=>$menuId));?>">编辑</a>
                            <a href="javascript:if(confirm('确实要删除吗?'))location='<?php echo U('Agent/deleteAdmin',array('adminid'=>$vo['admin_id'],'gd'=>$groupId,'md'=>$menuId));?>'">删除</a>
                            <a href="<?php echo U('Agent/addAdminAndRoles',array('adminid'=>$vo['admin_id'],'gd'=>$groupId,'md'=>$menuId));?>">权限</a>
                            </td>
