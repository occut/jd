                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div style="float: right;">
                                <h3 class="box-title"><a href="<?php echo U('Qq/WechaGroupsWhole');?>" class="btn btn-block btn-primary">全部账号</a></h3>
                                <h3 class="box-title"><a href="<?php echo U('Qq/WechaGroups');?>" class="btn btn-block btn-primary">正常账号</a></h3>
                                <h3 class="box-title"><a href="<?php echo U('Qq/WechaGroupsLogin');?>" class="btn btn-block btn-primary">已用账号</a></h3>
                                <h3 class="box-title"><a href="<?php echo U('Qq/WechaAbnormal');?>" class="btn btn-block btn-primary">账号异常</a></h3>
                            </div>
                            <br/>
                            <hr/>
                            ...
                            <form class="layui-form"   action="<?php echo U('Qq/searchAddr');?>">
