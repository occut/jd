                                    ...
                                    <div class="box-body">
                                        <table id="example2" class="table table-bordered table-hover layui-table" style = "text-align: center;">
                                            ...
                                            <?php if(is_array($tasks)): $i = 0; $__LIST__ = $tasks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tnd">
                                                    ...
                                                    <td style="text-align: center;"><span><?php echo selectpayment($vo['seller'])['ag_name'];?></span></td>
                                                    <td style="text-align: center;"><span><?php echo ($vo["addtime"]); ?></span></td>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:;" onclick="add('查看任务','<?php echo U('Tasks/viewliuliang',array('id'=>$vo['liuliang_id']));?>')">查看</a>
                                                    </td>
                                                    <td style="text-align: center;">
                                                    <a href="javascript:if(confirm('是否通过审核?')) location='<?php echo U('Tasks/Wanderingtask',array('id'=>$vo['liuliang_id']));?>'">
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <a href="javascript:if(confirm('确实要删除吗?')) location='<?php echo U('Tasks/dellliuliang',array('id'=>$vo['liuliang_id']));?>'" style="display: <?php if($vo["status"] == 0): ?>none<?php else: ?>block<?php endif; ?>">取消任务</a>
                                                    </td>
                                                    <td style="text-align: center;"><a href="<?php echo U('Tasks/WeExportliu',array('id'=>$vo['liuliang_id']));?>">下载</a></td>
