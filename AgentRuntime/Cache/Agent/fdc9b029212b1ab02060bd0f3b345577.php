                ...
                <div class="col-xs-12" style="margin-right:0px; ">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <p><h3 class="box-title"><a href="">余额：<?php echo ($con['ba_balance']); ?></a></h3></p>
                            <!--<h3 class="box-title"><a href="">jd：<?php echo ($count); ?></a></h3>-->
                            <!--<h3 class="box-title"><a href="">qq：<?php echo ($qq); ?></a></h3>-->
                            <h3 class="box-title"><a href="">单价：<?php echo ($jia); ?></a></h3>
                            <br/>
                            <hr/>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <form class="layui-form" action="<?php echo U('Wechat/purchases');?>" method="post">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <select  name='wei_data' id = "eq_id">
                                                <option value="jd">京东账号</option>
                                                <option value="qq">手Q账号</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label" style="width: 120px;">购买量</label>
                                    <div class="layui-input-inline">
                                        <input type="text" name="title" required  lay-verify="required" placeholder="请输入购买数量" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
