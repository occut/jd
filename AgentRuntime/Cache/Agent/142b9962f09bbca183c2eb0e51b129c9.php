      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" class="layui-form" method="post" action="<?php echo U('Shop/editShop');?>" enctype="multipart/form-data">
              <div class="box-body">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                          <select name="management" lay-verify="required">
                              ...
                              <?php if(is_array($con)): $i = 0; $__LIST__ = $con;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["ag_id"]); ?>" <?php if($data['seller_id'] == $vo['ag_id'] ) echo "selected";?>><?php echo ($vo["ag_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                          </select>
                      </div>
                  </div>
             <!--    <div class="layui-form-item">
