                    ...
                    <div class="box">
                        ...
                        <div class="layui-tab-item layui-show">
                            <table class="layui-table">
                                ...
                                <tr>
                                    <td>用户名 </td>
                                    <td><?php echo ($con['ag_name']); ?></td>
                                    <td>QQ</td>
                                    <td><?php echo ($con['ag_qq']); ?></td>
                                </tr>
                                <tr>
                                    <td>手机</td>
                                    <td><?php echo ($con['ag_phone']); ?></td>
                                    <td>IP</td>
                                    <td><?php echo ($con['ag_ip']); ?></td>
                                </tr>
                                <tr>
                                    <td>微信</td>
                                    <td><?php echo ($con['ag_wx']); ?></td>
                                    <td>邮箱</td>
                                    <td><?php echo ($con['ag_mb']); ?></td>
                                </tr>
                                <tr>
                                    <td>注册时间</td>
                                    <td><?php echo ($con['ag_time']); ?></td>
                                    <td>登录时间</td>
                                    <td><?php echo ($con['ag_ltime']); ?></td>
                                </tr>
                                <tr>
                                    <td>店铺</td>
                                    <td><?php echo ($con['shop_name']); ?></td>
                                </tr>
                                </tbody>
                            </table>
                            <br>
