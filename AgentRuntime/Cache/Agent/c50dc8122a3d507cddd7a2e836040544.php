                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><a href="<?php echo U('Finance/index');?>" class="btn btn-block btn-primary">员工做单登记</a></h3>
                            <h3 class="box-title"><a href="<?php echo U('Finance/logistics');?>" class="btn btn-block btn-primary">物流登记</a></h3>
                            <h3 class="box-title"><a href="<?php echo U('Finance/flow');?>" class="btn btn-block btn-primary">流量登记</a></h3>
                            <h3 class="box-title"><a href="<?php echo U('Finance/volume');?>" class="btn btn-block btn-primary">单量登记</a></h3>
                            <br/>
                        </div>
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tr class="tng">
                                                ...
                                                <th style = "text-align: center;">当天单量</th>
                                                <th style = "text-align: center;">总金额</th>
                                                <th style = "text-align: center;">当天日期</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php if(is_array($usergroups)): $i = 0; $__LIST__ = $usergroups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tnd" style = "text-align: center;">
                                                    <td><?php echo ($vo["em_id"]); ?></td>
                                                    <td><?php echo selectpayment($vo['eq_id'])['ag_name'];?></td>
                                                    <td><?php echo ($vo["en_nubmer"]); ?></td>
                                                    <td><?php echo ($vo["am_mone"]); ?></td>
                                                    <td><?php echo ($vo["en_time"]); ?></td>
