                                ...
                                <div class="layui-inline">
                                    <div class="layui-input-inline" >
                                        <select  name='sellertask' id = "sellertask">
                                            <?php if(is_array($sellertask)): $i = 0; $__LIST__ = $sellertask;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$st): $mod = ($i % 2 );++$i;?><option value="<?php echo ($st["task_id"]); ?>"><?php echo ($st["keyword"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="layui-inline">
