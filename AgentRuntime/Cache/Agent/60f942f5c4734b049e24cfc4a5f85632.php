...
<head>
    ...
    <script>
        Win10.onReady(function () {
            ...
            //设置壁纸
            Win10.setBgUrl({
                main:"/AdminResource/adminhome/images//wallpapers/main.jpg",
...
<span class="layui-badge layui-bg-gray" style="color: #000;display: none;">
                <p style="padding-left: 10px">用户：<?php echo session('AgentName');?></p>
                <p style="padding-left: 10px">金币：<?php echo ($con['ba_balance']); ?></p>
            </span>
        <script>
            layer.open({
                type: 1,
...
//                        layer.msg('捕获就是从页面已经存在的元素上，包裹layer的结构', {time: 5000, icon:6});
        ...
        <div id="win10-shortcuts" class="shortcuts-hidden">
            <!--$resources-->
            <?php if(is_array($WinMenu)): $i = 0; $__LIST__ = $WinMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="shortcut" onclick="Win10.openUrl('/Agent.php<?php echo ($vo['wi_path']); ?>','<img class=\'icon\' src=\'/AdminResource/adminhome/images//<?php echo ($vo['wi_icon']); ?>\'/><?php echo ($vo['wi_name']); ?>')">
                    <img class="icon" src="/AdminResource/adminhome/images//<?php echo ($vo['wi_icon']); ?>"/>
                    <div class="title"><?php echo ($vo['wi_name']); ?></div>
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            <div class="item" onclick="Win10.openUrl('/Agent.php/Profile/index','<img class=\'icon\' src=\'/AdminResource/adminhome/images//icon/个人中心.png\'/><?php echo session('AgentName');?>')"><img class="icon" src='/AdminResource/adminhome/images//icon/个人中心.png'/><?php echo session('AgentName');?></div>
