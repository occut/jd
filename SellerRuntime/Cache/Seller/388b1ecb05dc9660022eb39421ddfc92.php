...
<head>
    ...
    <script type="text/javascript" src="/AdminResource/seller//win10.js"></script>
    <style>
        * {
    ...
    <script>
        Win10.onReady(function () {
            ...
            //设置壁纸
            Win10.setBgUrl({
                main:"/AdminResource/admin/images/background.jpg",
...
<div id="win10">
    <div class="desktop">
        <span class="layui-badge layui-bg-gray" style="color: #000;display: none;">
                <p style="padding-left: 10px">用户：<?php echo ($admin); ?></p>
                <p style="padding-left: 10px">金币：<?php echo ($balance['seller_money']); ?></p>
            </span>
        <script>
            layer.open({
                type: 1,
                ...
                shade: false,
                title: false, //不显示标题
                content: $('.layui-bg-gray'), //捕获的元素，注意：最好该指定的元素要存放在body最外层，否则可能被其它的相对元素所影响
                cancel: function(){
//                        layer.msg('捕获就是从页面已经存在的元素上，包裹layer的结构', {time: 5000, icon:6});
        ...
        <div id="win10-shortcuts" class="shortcuts-hidden">
            <!--$resources-->
            <?php if(is_array($WinMenu)): $i = 0; $__LIST__ = $WinMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="shortcut" onclick="Win10.openUrl('/Seller.php<?php echo ($vo['menu_link']); ?>','<img class=\'icon\' src=\'/AdminResource/adminhome/images//<?php echo ($vo['menu_icon']); ?>\'/><?php echo ($vo['menu_name']); ?>')">
                    <img class="icon" src="/AdminResource/adminhome/images//<?php echo ($vo['menu_icon']); ?>"/>
                    <div class="title"><?php echo ($vo['menu_name']); ?></div>
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            <div class="item" onclick="Win10.openUrl('/admin.php/Admin/editAdmin/adminid/<?php echo session('SellerId');?>','<img class=\'icon\' src=\'/AdminResource/adminhome/images//icon/<?php echo ($vo['menu_icon']); ?>\'/><?php echo ($vo['menu_name']); ?>')"><img class="icon" src="<?php echo session('header');?>"/><?php echo session('SellerName');?></div>
