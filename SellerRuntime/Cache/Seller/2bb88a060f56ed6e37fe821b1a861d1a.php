...
<div class="layui-body" style="left:0;">
    <div class="content-wrapper" style = "margin-left:1px ;">
        ...
        <section class="content">
            ...
            <form  method="post" action="<?php echo U('Tasks/tasksstore');?>" class="layui-form" id="formid">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px;margin-left:0px;">
                        <input type="number" name="num" required  lay-verify="required" placeholder="下单商品件数" autocomplete="off" class="layui-input" id="num">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px;margin-left:0px;">
                        <input type="text" name="keyword" required  lay-verify="required" placeholder="此处只填写搜索商品关键词,如:电饭锅" id="keyword" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <!--<div class="layui-form-item">-->
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px;margin-left:0px;">
                        <textarea id="des" type="text" name="description" required  lay-verify="required" placeholder="搜索时是否需要筛选条件：如，卡价格，卡地区，如没有无需填写" autocomplete="off" class="layui-input"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width:150px;">订单数量</label>
                    <div class="layui-input-inline" style="width:300px;margin-left:0px;">
                        <input  type="number" name="order_num" required  lay-verify="required" placeholder="购物车订单需要重复做的次数" autocomplete="off" class="layui-input order" min="1" id="order_num">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px;margin-left:0px;">
                        <input type="text" name="order_money"  placeholder="每笔订单实际付款的金额" autocomplete="off" class="layui-input order" id="order_money" value="0">
                    </div>
                    <br/>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="transfer" class="transfer" value="0" title="不需要物流" checked lay-filter="transfer">
                        <input type="radio" name="transfer" class="transfer" value="1" title="需要物流(顺丰物流2.5金币)" lay-filter="transfer">
                    </div>
               ...
               <!--</div>-->
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px;margin-left:0px;">
                        <input type="text" id="buyer_mark" name="buyer_mark"  placeholder="下单时候需要备注什么或者留言" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"  style="width:150px;">结算方式</label>
                    <div class="layui-input-block" id="payWay">
                        <input type="radio" name="payWay" value="0" title="预付" lay-filter="pay" checked class="payWay">
                        <input type="radio" name="payWay" value="1" title="垫付" lay-filter="pay" class="payWay">
                    </div>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px;margin-left:0px;" id="yongjing">
                        <input type="text" name="yongjing"  placeholder="" autocomplete="off" class="layui-input" readonly value="" id="tips1">
                    </div>
        ...
        layer.open({
            ...
            ,yes: function(){
                $.ajax({
                    cache: true,
                    type: "POST",
                    url: '<?php echo U("Tasks/tasksstore");?>',
