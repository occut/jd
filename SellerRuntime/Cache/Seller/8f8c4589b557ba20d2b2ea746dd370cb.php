      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo U('Shop/editAddress');?>" enctype="multipart/form-data" class="layui-form">
                <input type="hidden" name="beigin_id" value="<?php echo ($data['id']); ?>">
              <div class="box-body">
                 <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                        ...
                        <input type="text" name="shop_name" required  lay-verify="required" placeholder="请输入店铺名称" value="<?php echo ($data['shop']); ?>" autocomplete="off" class="layui-input" readonly>
                    </div>
                </div>
                  <div class="layui-form-item">
                  <label class="layui-form-label" style="width:150px;">寄件人</label>
                  <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                      <input type="text" name="seller" required  lay-verify="required" placeholder="" value="<?php echo ($data['seller']); ?>" autocomplete="off" class="layui-input">
                  </div>
              </div>
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                          <select  name="provinceId" lay-verify="required" lay-filter="province">
                              <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pr): $mod = ($i % 2 );++$i;?><option value="<?php echo ($pr["id"]); ?>" <?php if($data['pro'] == $pr['id']): ?>selected<?php endif; ?>><?php echo ($pr["province"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                          </select>
                      </div>
                      <div class="layui-input-inline" style="width:200px;margin-left:0px;" id="listAllConfigs">
                          <select  name="cityId" lay-verify="required" >
                          <?php if(is_array($city)): $i = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($data['ci'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["city"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                          </select>
                      </div>
                  </div>
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                          <input type="text" name="details" required  lay-verify="required" placeholder="" value="<?php echo ($data['details']); ?>" autocomplete="off" class="layui-input">
                      </div>
                  </div>
                  <div class="layui-form-item">
                      <label class="layui-form-label" style="width:150px;">电话</label>
                      <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                          <input type="text" name="phone" required  lay-verify="required" placeholder="" value="<?php echo ($data['phone']); ?>" autocomplete="off" class="layui-input">
                      </div>
                  </div>
                  <div class="layui-form-item">
                      <label class="layui-form-label" style="width:150px;">手机</label>
                      <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                          <input type="text" name="mb_phone" required  lay-verify="required" placeholder="" value="<?php echo ($data['mb_phone']); ?>" autocomplete="off" class="layui-input">
                      </div>
                  </div>
