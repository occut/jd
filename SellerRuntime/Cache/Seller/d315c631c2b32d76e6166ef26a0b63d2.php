...
<div class="layui-body" style="left:0;">
    <div class="content-wrapper" style = "margin-left:1px ;">
        ...
        <section class="content">
            ...
            <form class="layui-form" method="post" action="<?php echo U('Tasks/liuliangcreate');?>" id="formid">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px;">
                        <select  name="shops" lay-verify="required">
                            <?php if(is_array($shops)): $i = 0; $__LIST__ = $shops;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["shop_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
        ...
        layer.open({
            ...
            ,yes: function(){
                $.ajax({
                    cache: true,
                    type: "POST",
                    url: '<?php echo U("Tasks/liuliangcreate");?>',
