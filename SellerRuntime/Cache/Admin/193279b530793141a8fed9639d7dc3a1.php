        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                   ...
                   <h3 class="box-title"><a href="<?php echo U('Agent/editPass',array('adminid'=>$selectadmin['admin_id'],'gd'=>$groupId,'md'=>$menuId));?>"><button type="button" class="btn btn-block btn-default">修改密码</button></a></h3>
            ...
            <!-- form start -->
            <form action="<?php echo U('Agent/editAdmin');?>" method="post" >
