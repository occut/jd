            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="<?php echo U('Agent/balance');?>" method="post" >
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="adminname">验证码</label>
                                        <input type="text" class="form-control" name="vo" autofocus id="adminname" placeholder="请输入验证码" required="required">
                                    </div>
