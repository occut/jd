                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <a href="<?php echo U('Agent/account');?>" class="layui-btn ">账号登记</a>
                            <a href="<?php echo U('Agent/AgentLogistics');?>" class="layui-btn ">物流登记</a>
                            <a href="<?php echo U('Agent/AgentFlow');?>" class="layui-btn ">流量登记</a>
                            <a href="<?php echo U('Agent/volume');?>" class="layui-btn ">单量登记</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover layui-table" style = "text-align: center;">
                                ...
                                <?php if(is_array($Agent)): $i = 0; $__LIST__ = $Agent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tnd">
                                        <td><input type="checkbox" value="<?php echo ($vo["ac_id"]); ?>" name="delAll"></td>
                                        <td><?php echo ($vo["lo_id"]); ?></td>
                                        <td><?php echo selectagent($vo['lo_ag_id'])['ag_name'];?></td>
                                        <td><?php echo ($vo["lo_num"]); ?></td>
                                        <td><?php echo ($vo["lo_money"]); ?></td>
                                        <td><?php echo ($vo["lo_time"]); ?></td>
                                        <td>
                                            <?php if(($vo["lo_state"]) == "1"): ?>成功
                                                <?php else: ?>失败<?php endif; ?></td>
                                        </td>
                                        <td><?php echo ($vo["lo_ip"]); ?></td>
