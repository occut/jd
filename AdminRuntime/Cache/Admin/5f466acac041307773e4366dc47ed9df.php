              ...
              <div class="box-body">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                        ...
                        <?php if(is_array($allEquipment)): $i = 0; $__LIST__ = $allEquipment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$allE): $mod = ($i % 2 );++$i;?><option><?php echo ($allE["equlist"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
