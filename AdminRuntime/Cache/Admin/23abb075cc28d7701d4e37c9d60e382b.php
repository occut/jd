...
<div class="layui-body">
    ...
    <section class="content">
        <div class="row">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo U('Agent/create');?>" method="post" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                      <label for="ag_fullname">姓名</label>
                      <input type="text" class="form-control" name="ag_fullname"  placeholder="请输入姓名" required="required">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      <label for="ag_qq">QQ</label>
                      <input type="text" class="form-control" name="ag_qq"  placeholder="请输入QQ" required="required">
                  </div>
                    <!-- radio -->
                            <div class="form-group">
