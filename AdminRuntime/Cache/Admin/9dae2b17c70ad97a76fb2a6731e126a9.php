        ...
        <ul class="layui-nav top_menu">
            <li class="layui-nav-item" pc>
                ...
                <dl class="layui-nav-child">
                    <dd> <a href="<?php echo U('Agent/listAdmins',array('gd'=>4,'md'=>67));?>">管理员</a></dd>
                    <dd> <a href="<?php echo U('Agent/listRoles',array('gd'=>4,'md'=>68));?>">角色</a></dd>
                    <dd>  <a href="<?php echo U('Agent/listModules',array('gd'=>4,'md'=>69));?>">模块</a></dd>
                    <dd> <a href="<?php echo U('Agent/editPassword',array('gd'=>4,'md'=>70));?>" >改密</a></dd>
                ...
                <div class="box">
                    <div class="box-header">
                      <h3 class="box-title"><a href="<?php echo U('Agent/listAdmins');?>"><button type="button" class="btn btn-block btn-default">管理员列表</button></a></h3>
                        ...
                        <h3 class="box-title"><a href="#"><button type="button" class="btn btn-block btn-primary">修改密码</button></a></h3>

                    </div>
                    <!-- /.box-header -->
                    <!-- /.box-header -->
                    <!-- form start -->
            <form action="<?php echo U('Agent/editPass');?>" method="post" >
                <input type="hidden" name="adminid" value="<?php echo ($adminpass["admin_id"]); ?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="adminname">用户名：</label>
              <span id="font1"><?php echo ($adminpass["admin_name"]); ?></span>
                </div>                                  
                  <div class="form-group">
