                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <form method="get" style="float: left;" action="<?php echo U('Agent/AgExport');?>">
                                <!--<div class="box-header">-->
                                <input style="float:left;width:100px;" type="hidden" name="ids" id="ids" vallue="">
                                <input type="submit" value="导出" class="layui-btn" onclick="iswechat()" style="width: 100px;margin: 0px 10px;">
                                <!--</div>-->
                            </form>
